...
@XmlType(name = "obtenerDocumentoMtomResponse", propOrder = {"documentoMtomResponse"},
...
public class ObtenerDocumentoMtomResponse {
  ...
  /**
   * @param documentoMtomResponse the documentoMtomResponse to set
   */
  public void setDocumentoMtomResponse(DocumentoMtomResponse documentoMtomResponse) {
    this.documentoMtomResponse = documentoMtomResponse;
  }
