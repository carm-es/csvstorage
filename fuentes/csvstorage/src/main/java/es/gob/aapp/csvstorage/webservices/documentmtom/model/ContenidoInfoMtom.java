...
@XmlType(name = "ContenidoMtomInfo", propOrder = {"contenido", "tipoMIME"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:documentmtom:model:v1.0")
public class ContenidoInfoMtom {
   ...
   * 
   * @return possible object is DataHandler
   */
   ...
   * 
   * @param value allowed object is DataHandler
   */
