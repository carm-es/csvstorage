...
/**
 * <p>
 * Clase Java para TipoAplicaciones complex type.
 * 
 * <p>
 * El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="TipoAplicaciones">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="IdAplicacion" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TipoAplicaciones", propOrder = {"idAplicacion"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
public class TipoAplicaciones {

  @XmlElement(name = "IdAplicacion", required = true)
  protected List<String> idAplicacion;
   ...
   * there is not a <CODE>set</CODE> method for the idAplicacion property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   * <pre>
   * getIdAplicacion().add(newItem);
   * </pre>
   * 
   * 
   * <p>
   ...
   * 
   */
  public List<String> getIdAplicacion() {
    if (idAplicacion == null) {
      idAplicacion = new ArrayList<String>();
    }
