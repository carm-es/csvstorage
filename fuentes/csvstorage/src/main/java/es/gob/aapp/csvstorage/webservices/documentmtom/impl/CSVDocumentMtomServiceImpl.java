...
import es.gob.aapp.csvstorage.webservices.documentmtom.CSVDocumentMtomService;
...
import es.gob.aapp.csvstorage.webservices.documentmtom.model.WSCredential;



@WebService(serviceName = "CSVDocumentMtomService", portName = "CSVDocumentMtomServicePort",
    targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0",
    endpointInterface = "es.gob.aapp.csvstorage.webservices.documentmtom.CSVDocumentMtomService")
...
public class CSVDocumentMtomServiceImpl implements CSVDocumentMtomService {
  ...
  @Override
  public Response guardar(WSCredential info, GuardarDocumentoMtomRequest guardarDocumentoMtom)
  ...
  @Override
  public Response guardarENI(WSCredential info, GuardarDocumentoEniMtomRequest guardarDocumentoENI)
      throws CSVStorageException {
  ...
  @Override
  public DocumentoEniMtomResponse obtenerENI(WSCredential info,
  ...
  @Override
  public DocumentoMtomResponse obtener(WSCredential info, ObtenerDocumentoRequest obtenerDocumento)
      throws CSVStorageException {
  ...
  @Override
  public Response modificar(WSCredential info, GuardarDocumentoMtomRequest modificarDocumentoMtom)
      throws CSVStorageException {
  ...
  @Override
  public Response modificarENI(WSCredential info,
      GuardarDocumentoEniMtomRequest modificarDocumentoENI) throws CSVStorageException {
  ...
  @Override
  public DocumentoEniMtomResponse convertirAEni(WSCredential info,
    ...
    ConvertirDocumentoEniMtomResponse response =
        (ConvertirDocumentoEniMtomResponse) saveDocumentEniBusinessService
            .convertirAEni(convertirDocumentoENI, info.getIdaplicacion(), true);
