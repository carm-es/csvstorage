...
public interface CSVDocumentService {
  ...
  @ResponseWrapper(localName = "consultarDocumentoPorCSVResponse",
      targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0",
      className = "es.gob.aapp.csvstorage.webservices.document.model.ConsultarDocumentoPorCSVResponse")
  @WebResult(name = "consultaResponse", targetNamespace = "")
  @WebMethod(operationName = "obtenerCertificado", action = "urn:obtenerCertificado")
  public ConsultaResponse obtenerCertificado(
      @WebParam(name = "credential", targetNamespace = "") @XmlElement(required = true,
          name = "credential") WSCredential info,
      @WebParam(name = "consultarDocumentoRequest", targetNamespace = "") @XmlElement(
          required = true,
  ...
  @ResponseWrapper(localName = "obtenerTamanioDocumentoResponse",
      targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
  @WebResult(name = "tamanioDocumentoResponse", targetNamespace = "")
  ...
  @ResponseWrapper(localName = "revocarPermisoConsultaResponse",
      ...
      className = "es.gob.aapp.csvstorage.webservices.document.model.GuardarDocumentoResponse")
  @WebResult(name = "response", targetNamespace = "")
  @WebMethod(operationName = "revocarPermisoConsulta", action = "urn:revocarPermisoConsulta")
  ...
  @WebResult(name = "Aplicacion", partName = "Aplicacion",
      targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
  public List<Aplicacion> consultarAplicaciones(@WebParam(name = "credential",
