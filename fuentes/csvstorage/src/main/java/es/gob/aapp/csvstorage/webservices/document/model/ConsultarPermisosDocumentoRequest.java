...
@XmlType(name = "consultarPermisosDocumentoRequest", propOrder = {"dir3", "csv", "idENI"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
public class ConsultarPermisosDocumentoRequest implements Serializable {
  ...
  public String toString() {
    return "ConsultarDocumentoRequest [csv=" + csv + ", idENI=" + idENI + ", dir3=" + dir3 + "]";
  }
