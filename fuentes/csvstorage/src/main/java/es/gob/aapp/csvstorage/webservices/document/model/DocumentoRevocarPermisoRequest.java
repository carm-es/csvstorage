...
@XmlType(propOrder = {"dir3", "csv", "idEni"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
public class DocumentoRevocarPermisoRequest implements Serializable {
  ...
  public String toString() {
    return new StringBuilder("DocumentoRevocarPermisoRequest [").append("dir3=" + dir3)
        .append(", csv=" + csv).append(", idEni=" + idEni).append("]").toString();
  }
