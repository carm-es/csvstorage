...
@WebFault(faultBean = "es.gob.aapp.csvstorage.webservices.administracion.model.ExceptionInfo",
    name = "errorInfo",
    targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:administracion:model:v1.0")
public class CSVStorageException extends Exception {

  private static final long serialVersionUID = 1L;

  @XmlElement(name = "exceptionInfo", required = true)
