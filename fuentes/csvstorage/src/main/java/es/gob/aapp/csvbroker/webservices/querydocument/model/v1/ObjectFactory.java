...
public class ObjectFactory {
  ...
  private final static QName _ErrorInfo_QNAME =
      new QName("urn:es:gob:aapp:csvbroker:webservices:querydocument:model:v1.0", "errorInfo");
  private final static QName _CSVQueryDocumentResponse_QNAME = new QName(
      "urn:es:gob:aapp:csvbroker:webservices:querydocument:model:v1.0", "CSVQueryDocumentResponse");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: es.gob.aapp.csvbroker.webservices.querydocument.model.v1
   * 
   */
   ...
   * 
   */
  @XmlElementDecl(namespace = "urn:es:gob:aapp:csvbroker:webservices:querydocument:model:v1.0",
      name = "errorInfo")
  public JAXBElement<CsvQueryDocumentException> createErrorInfo(CsvQueryDocumentException value) {
    return new JAXBElement<CsvQueryDocumentException>(_ErrorInfo_QNAME,
        CsvQueryDocumentException.class, null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "urn:es:gob:aapp:csvbroker:webservices:querydocument:model:v1.0",
      name = "CSVQueryDocumentResponse")
  public JAXBElement<CSVQueryDocumentResponse> createCSVQueryDocumentResponse(
      CSVQueryDocumentResponse value) {
    return new JAXBElement<CSVQueryDocumentResponse>(_CSVQueryDocumentResponse_QNAME,
        CSVQueryDocumentResponse.class, null, value);
  }
