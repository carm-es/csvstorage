...
/**
 * <p>
 * Clase Java para TipoDocumentoConversionInside complex type.
 * 
 * <p>
...
@XmlType(name = "TipoDocumentoConversionInside",
    propOrder = {"contenido", "contenidoId", "firmadoConCertificado", "metadatosEni", "csv"})
public class TipoDocumentoConversionInside {
   ...
   * 
   * @return possible object is {@link TipoDocumentoConversionInside.MetadatosEni }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link TipoDocumentoConversionInside.MetadatosEni }
   * 
   */
   ...
   * 
   * @return possible object is {@link TipoDocumentoConversionInside.Csv }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link TipoDocumentoConversionInside.Csv }
   * 
   */
