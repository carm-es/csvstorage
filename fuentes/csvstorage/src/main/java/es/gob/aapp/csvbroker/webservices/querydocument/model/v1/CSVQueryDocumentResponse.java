...
/**
 * <p>
 * Clase Java para CSVQueryDocumentResponse complex type.
 * 
 * <p>
...
@XmlType(name = "CSVQueryDocumentResponse",
    propOrder = {"code", "description", "documentResponse", "waitResponse"})
public class CSVQueryDocumentResponse {
   ...
   * 
   * @return possible object is {@link DocumentResponse }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link DocumentResponse }
   * 
   */
   ...
   * 
   * @return possible object is {@link WaitResponse }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link WaitResponse }
   * 
   */
