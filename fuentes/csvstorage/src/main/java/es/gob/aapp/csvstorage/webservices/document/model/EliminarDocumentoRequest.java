...
@XmlType(name = "eliminarDocumentoRequest", propOrder = {"dir3", "csv", "idENI"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
public class EliminarDocumentoRequest implements Serializable {
  ...
  public String toString() {
    return "EliminarDocumentoRequest [csv=" + csv + ", idENI=" + idENI + ", dir3=" + dir3 + "]";
  }
