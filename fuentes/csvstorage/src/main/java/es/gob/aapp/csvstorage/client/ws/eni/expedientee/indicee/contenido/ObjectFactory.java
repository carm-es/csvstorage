...
package es.gob.aapp.csvstorage.client.ws.eni.expedientee.indicee.contenido;
 ...
 * generated in the es.gob.aapp.csvstorage.client.ws.eni.expedientee.indicee.contenido package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _IndiceContenido_QNAME = new QName(
      "http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e/indice-e/contenido",
      "IndiceContenido");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: es.gob.aapp.csvstorage.client.ws.eni.expedientee.indicee.contenido
   * 
   */
   ...
   */
  @XmlElementDecl(
      namespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/expediente-e/indice-e/contenido",
      name = "IndiceContenido")
  public JAXBElement<TipoIndiceContenido> createIndiceContenido(TipoIndiceContenido value) {
    return new JAXBElement<TipoIndiceContenido>(_IndiceContenido_QNAME, TipoIndiceContenido.class,
        null, value);
  }
