...
/**
 * <p>
 * Clase Java para TipoMetadatos complex type.
 * 
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="Metadato" type="{}TipoMetadato" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TipoMetadatos", propOrder = {"metadato"},
...
public class TipoMetadatos {
  ...
  protected List<TipoMetadato> metadato;
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TipoMetadato }
   * 
   * 
   */
  public List<TipoMetadato> getMetadato() {
    if (metadato == null) {
      metadato = new ArrayList<TipoMetadato>();
    }
