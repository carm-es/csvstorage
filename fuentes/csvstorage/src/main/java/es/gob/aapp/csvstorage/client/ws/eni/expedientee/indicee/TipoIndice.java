...
package es.gob.aapp.csvstorage.client.ws.eni.expedientee.indicee;
...
import es.gob.aapp.csvstorage.client.ws.eni.expedientee.indicee.contenido.TipoIndiceContenido;
import es.gob.aapp.csvstorage.client.ws.eni.firma.Firmas;


/**
 * <p>
 * Clase Java para TipoIndice complex type.
 * 
 * <p>
...
public class TipoIndice {
  ...
  /**
   * Existir�, al menos, una firma del contenido del �ndice del expediente electr�nico.
   * 
