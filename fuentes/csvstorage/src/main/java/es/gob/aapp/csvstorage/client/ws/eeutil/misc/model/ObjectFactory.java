...
package es.gob.aapp.csvstorage.client.ws.eeutil.misc.model;
 ...
 * generated in the es.gob.aapp.csvstorage.client.ws.eeutil.misc.model package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _ValidarExpedienteDocumentosENIZIP_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "validarExpedienteDocumentosENIZIP");
  private final static QName _ValidarExpedienteDocumentosENIZIPResponse_QNAME = new QName(
      "http://service.ws.inside.dsic.mpt.es/", "validarExpedienteDocumentosENIZIPResponse");
   ...
   * for package: es.gob.aapp.csvstorage.client.ws.eeutil.misc.model
   * 
   */
  ...
  /**
   * Create an instance of {@link ValidarExpedienteDocumentosENIZIPResponse }
   * 
   */
  public ValidarExpedienteDocumentosENIZIPResponse createValidarExpedienteDocumentosENIZIPResponse() {
    return new ValidarExpedienteDocumentosENIZIPResponse();
  }

  /**
   * Create an instance of {@link ValidarExpedienteDocumentosENIZIP }
   * 
   */
  public ValidarExpedienteDocumentosENIZIP createValidarExpedienteDocumentosENIZIP() {
    return new ValidarExpedienteDocumentosENIZIP();
  }
  ...
  /**
   * Create an instance of {@link Validaciones }
   * 
   */
  public Validaciones createValidaciones() {
    return new Validaciones();
  }

  /**
   * Create an instance of {@link DocumentoEntradaMtom }
   * 
   */
  public DocumentoEntradaMtom createDocumentoEntradaMtom() {
    return new DocumentoEntradaMtom();
  }
  ...
  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link ValidarExpedienteDocumentosENIZIP
   * }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "validarExpedienteDocumentosENIZIP")
  public JAXBElement<ValidarExpedienteDocumentosENIZIP> createValidarExpedienteDocumentosENIZIP(
      ValidarExpedienteDocumentosENIZIP value) {
    return new JAXBElement<ValidarExpedienteDocumentosENIZIP>(
        _ValidarExpedienteDocumentosENIZIP_QNAME, ValidarExpedienteDocumentosENIZIP.class, null,
        value);
  }

  /**
   * Create an instance of {@link JAXBElement
   * }{@code <}{@link ValidarExpedienteDocumentosENIZIPResponse }{@code >}}
   * 
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "validarExpedienteDocumentosENIZIPResponse")
  public JAXBElement<ValidarExpedienteDocumentosENIZIPResponse> createValidarExpedienteDocumentosENIZIPResponse(
      ValidarExpedienteDocumentosENIZIPResponse value) {
    return new JAXBElement<ValidarExpedienteDocumentosENIZIPResponse>(
        _ValidarExpedienteDocumentosENIZIPResponse_QNAME,
        ValidarExpedienteDocumentosENIZIPResponse.class, null, value);
  }
