...
@WebService(targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:administration:v1.0",
    name = "AdminWSService")
public interface AdminWSService {
  ...
  public Aplicacion altaAplicacion(@WebParam(name = "aplicacion",
      targetNamespace = "") @XmlElement(required = true, name = "aplicacion") Aplicacion aplicacion)
      throws CSVStorageException;

  @WebMethod(operationName = "bajaAplicacion", action = "urn:bajaAplicacion")
  @WebResult(name = "Aplicacion", partName = "Aplicacion",
      targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:administration:model:v1.0")
  public Aplicacion bajaAplicacion(@WebParam(mode = WebParam.Mode.IN, name = "idAplicacion",
      targetNamespace = "") java.lang.String idAplicacion) throws CSVStorageException;
  ...
  @WebResult(name = "Aplicacion", partName = "Aplicacion",
      targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:administration:model:v1.0")
  public Aplicacion eliminaAplicacion(@WebParam(mode = WebParam.Mode.IN, name = "idAplicacion",
      targetNamespace = "") java.lang.String idAplicacion) throws CSVStorageException;
