...
package es.gob.aapp.csvstorage.consumer.eeutil;
...
public interface EeutilConsumer {

  RespuestaValidacionENI validarDocumentoENI(DocumentoEntradaMtom documentoEntradaMtom)
