...
package es.gob.aapp.csvstorage.consumer.ginside;
...
public interface GInsideUserTokenConsumer {
  ...
  DocumentoEniFileInside convertirDocumentoAEni(TipoDocumentoConversionInside documento,
