...
/**
 * <p>
 * Clase Java para TipoDocumentoMtom complex type.
 * 
 * <p>
...
@XmlType(name = "TipoDocumentoMtom", propOrder = {"contenidoMtom", "metadatos", "firmas"})
public class TipoDocumentoMtom {
  ...
  /**
   * Obtiene el valor de la propiedad contenidoMtom.
   * 
  ...
  /**
   * Define el valor de la propiedad contenidoMtom.
   * 
