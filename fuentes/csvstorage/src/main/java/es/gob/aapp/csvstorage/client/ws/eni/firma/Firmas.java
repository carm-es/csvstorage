...
/**
 * <p>
 * Clase Java para firmas complex type.
 * 
 * <p>
...
@XmlType(name = "firmas", propOrder = {"firma"})
public class Firmas {
   ...
   * there is not a <CODE>set</CODE> method for the firma property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TipoFirmasElectronicas }
   * 
   * 
   */
