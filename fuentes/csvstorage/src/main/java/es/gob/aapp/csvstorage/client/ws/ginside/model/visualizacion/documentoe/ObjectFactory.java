...
package es.gob.aapp.csvstorage.client.ws.ginside.model.visualizacion.documentoe;
 ...
 * generated in the es.gob.aapp.csvstorage.client.ws.ginside.model.visualizacion.documentoe package.
 * <p>
...
public class ObjectFactory {
  ...
  private final static QName _DocumentoVisualizacion_QNAME =
      new QName("https://ssweb.seap.minhap.es/Inside/XSD/v1.0/visualizacion/documento-e",
          "documentoVisualizacion");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: es.gob.aapp.csvstorage.client.ws.ginside.model.visualizacion.documentoe
   * 
   */
  ...
  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link TipoDocumentoVisualizacionInside
   * }{@code >}}
   * 
   */
  @XmlElementDecl(
      namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/visualizacion/documento-e",
      name = "documentoVisualizacion")
  public JAXBElement<TipoDocumentoVisualizacionInside> createDocumentoVisualizacion(
      TipoDocumentoVisualizacionInside value) {
    return new JAXBElement<TipoDocumentoVisualizacionInside>(_DocumentoVisualizacion_QNAME,
        TipoDocumentoVisualizacionInside.class, null, value);
  }
