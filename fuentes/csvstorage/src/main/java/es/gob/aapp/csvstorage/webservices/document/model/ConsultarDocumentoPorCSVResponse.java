...
@XmlType(name = "consultarDocumentoPorCSVResponse", propOrder = {"consultaResponse"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
public class ConsultarDocumentoPorCSVResponse {

  @XmlElement(name = "consultaResponse", required = false)
