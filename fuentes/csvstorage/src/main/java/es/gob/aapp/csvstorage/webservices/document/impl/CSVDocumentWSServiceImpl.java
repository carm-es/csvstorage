...
import es.gob.aapp.csvstorage.webservices.document.CSVDocumentWSService;
...
@WebService(serviceName = "CSVDocumentWSService", portName = "CSVDocumentWSServicePort",
    targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:document:v1.0",
    endpointInterface = "es.gob.aapp.csvstorage.webservices.document.CSVDocumentWSService")
...
public class CSVDocumentWSServiceImpl implements CSVDocumentWSService {
  ...
  /** Inyeccion de los servicios business de almacenamiento de informes. */
  @Autowired
  ...
  /** Inyeccion de los servicios business de almacenamiento de documentos ENI. */
  @Autowired
  ...
  public DocumentoPermisoResponse consultarPermisosDocumento(
    ...
    // response.getDocumentoPermisoResponse().setDireccion(request.getRequestURL().toString());
