...
public class WSClientUtil {
   ...
   */
  public static void setupTLS(Client client, String truststorePath, String truststorePass,
      String truststoreType) throws FileNotFoundException, IOException, GeneralSecurityException {
  ...
  /**
   * Calcula el path real de un path que puede contener una variable de entorno entre las cadenas
   * "${" y "}". Si no encuentra estas cadenas lo devuelve tal cual.
   * 
   * @param path
   * @return
   */
