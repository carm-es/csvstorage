...
/**
 * This class was generated by Apache CXF 3.0.1 2016-01-12T18:01:56.432+01:00 Generated source
 * version: 3.0.1
 * 
 */
@WebService(targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService",
    name = "GInSideWebService")
...
public interface GInSideWebService {
  ...
  public es.gob.aapp.csvstorage.client.ws.ginside.model.expedientee.TipoExpedienteInsideConMAdicionales convertirExpedienteAEniConMAdicionalesAutocontenido(
  ...
  public es.gob.aapp.csvstorage.client.ws.eni.documentoe.TipoDocumento convertirDocumentoAEni(
      @WebParam(name = "credential",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService") es.gob.aapp.csvstorage.client.ws.ginside.WSCredentialInside credential,
  ...
  public es.gob.aapp.csvstorage.client.ws.ginside.model.documentoe.TipoDocumentoInsideConMAdicionales convertirDocumentoAEniConMAdicionales(
      @WebParam(name = "credential",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService") es.gob.aapp.csvstorage.client.ws.ginside.WSCredentialInside credential,
      @WebParam(name = "documento",
          targetNamespace = "") es.gob.aapp.csvstorage.client.ws.ginside.model.documentoe.conversion.TipoDocumentoConversionInside documento,
  ...
  public es.gob.aapp.csvstorage.client.ws.eni.expedientee.TipoExpediente convertirExpedienteAEni(
      @WebParam(name = "credential",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService") es.gob.aapp.csvstorage.client.ws.ginside.WSCredentialInside credential,
      @WebParam(name = "expediente",
  ...
  public es.gob.aapp.csvstorage.client.ws.eni.expedientee.TipoExpediente convertirExpedienteAEniAutocontenido(
      @WebParam(name = "credential",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService") es.gob.aapp.csvstorage.client.ws.ginside.WSCredentialInside credential,
      @WebParam(name = "expediente",
          targetNamespace = "") es.gob.aapp.csvstorage.client.ws.ginside.model.expedientee.conversion.TipoExpedienteConversionInsideWS expediente,
  ...
  public es.gob.aapp.csvstorage.client.ws.ginside.model.expedientee.TipoExpedienteInsideConMAdicionales convertirExpedienteAEniConMAdicionales(
      @WebParam(name = "credential",
          targetNamespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/WebService") es.gob.aapp.csvstorage.client.ws.ginside.WSCredentialInside credential,
      @WebParam(name = "expediente",
          targetNamespace = "") es.gob.aapp.csvstorage.client.ws.ginside.model.expedientee.conversion.TipoExpedienteConversionInside expediente,
