...
public enum FormatoFirma {
  ...
  @XmlEnumValue("TF01")
  TF_01("TF01"), @XmlEnumValue("TF02")
  TF_02("TF02"), @XmlEnumValue("TF03")
  TF_03("TF03"), @XmlEnumValue("TF04")
  TF_04("TF04"), @XmlEnumValue("TF05")
  TF_05("TF05"), @XmlEnumValue("TF06")
  TF_06("TF06");
  private final String value;

  FormatoFirma(String v) {
    value = v;
  }
  ...
  public static FormatoFirma fromValue(String v) {
    for (FormatoFirma c : FormatoFirma.values()) {
      if (c.value.equals(v)) {
        return c;
      }
    }
