...
public class DocumentException extends Exception {
   ...
   */
  public DocumentException(String message, ExceptionInfo exceptionInfo) {
    super(message);
   ...
   * @param exceptionInfo Exception info.
   */
  public DocumentException(String message, ExceptionInfo exceptionInfo, Throwable cause) {
    super(message, cause);
    this.exceptionInfo = exceptionInfo;
  }
