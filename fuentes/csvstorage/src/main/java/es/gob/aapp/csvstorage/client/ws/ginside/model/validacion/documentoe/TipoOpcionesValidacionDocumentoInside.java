...
/**
 * <p>
 * Clase Java para TipoOpcionesValidacionDocumentoInside complex type.
 * 
 * <p>
...
@XmlType(name = "TipoOpcionesValidacionDocumentoInside", propOrder = {"opcionValidacionDocumento"})
public class TipoOpcionesValidacionDocumentoInside {
   ...
   * there is not a <CODE>set</CODE> method for the opcionValidacionDocumento property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TipoOpcionValidacionDocumento }
   * 
   * 
   */
