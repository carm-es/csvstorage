...
import es.gob.aapp.csvbroker.webservices.querydocument.CSVQueryDocumentWSService;
...
/**
 * Implementació del web service CSVQueryDocumentWSServiceImpl.
 * 
 * @author carlos.munoz1
 *
 */
@WebService(serviceName = "CSVQueryDocumentWSService", portName = "CSVQueryDocumentWSServicePort",
    targetNamespace = "urn:es:gob:aapp:csvbroker:webservices:querydocument:v1.0",
    endpointInterface = "es.gob.aapp.csvbroker.webservices.querydocument.CSVQueryDocumentWSService")
...
public class CSVQueryDocumentWSServiceImpl implements CSVQueryDocumentWSService {
  ...
  public CsvQueryDocumentSecurityWSSResponse csvQueryDocumentSecurity(
    ...
    try {
      ...
      DocumentObject documentObject = new DocumentObject();
      BeanUtils.copyProperties(csvQueryDocumentSecurityWSS.getQueryDocumentSecurityRequest(),
          documentObject);
      documentObject.setCalledFrom(Constants.CALLED_FROM_QUERY_SERVICE);
      documentObject.setParametrosAuditoria(
          csvQueryDocumentSecurityWSS.getQueryDocumentSecurityRequest().parametrosAuditoria());
