...
import es.gob.aapp.csvstorage.webservices.documentmtom.CSVDocumentWSMtomService;
...
@WebService(serviceName = "CSVDocumentWSMtomService", portName = "CSVDocumentWSMtomServicePort",
    targetNamespace = "urn:es:gob:aapp:csvstorage:webservices:documentmtom:v1.0",
    endpointInterface = "es.gob.aapp.csvstorage.webservices.documentmtom.CSVDocumentWSMtomService")
