...
@XmlType(name = "DocumentoReferenciaResponse", propOrder = {"referenciaDocumento"},
    namespace = "urn:es:gob:aapp:csvstorage:webservices:document:model:v1.0")
public class DocumentoReferenciaResponse extends Response {
  ...
  /**
   * @param referenciaDocumento the contenido to set
   */
  public void setReferenciaDocumento(byte[] referenciaDocumento) {
