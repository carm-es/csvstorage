...
package es.gob.aapp.csvstorage.client.ws.eni.expedientee.mtom;
...
import es.gob.aapp.csvstorage.client.ws.eni.expedientee.indicee.TipoIndice;
import es.gob.aapp.csvstorage.client.ws.eni.expedientee.metadatos.TipoMetadatos;


/**
 * Para el intercambio de un expediente electr�nico, se env�a en primer lugar, el �ndice del
 * expediente. Posteriormente, se enviar�n los documentos que lo componen , uno a uno, y siguiendo
 * la distribuci�n reflejada en el contenido del �ndice.
 * 
 * <p>
 * Clase Java para TipoExpedienteMtom complex type.
 * 
 * <p>
...
@XmlType(name = "TipoExpedienteMtom", propOrder = {"indice", "metadatosExp", "visualizacionIndice"})
public class TipoExpedienteMtom {
   ...
   * 
   * @return possible object is {@link TipoContenidoMtom }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link TipoContenidoMtom }
   * 
   */
