...
/**
 * <p>
 * Clase Java para TipoEstadoElaboracion complex type.
 * 
 * <p>
...
public class TipoEstadoElaboracion {
  ...
  public String parametrosAuditoria() {
    String audit = "ValorEstadoElaboracion" + Constants.AUDIT_SEPARATOR_VALUE
        + this.valorEstadoElaboracion.value();
    audit += (this.identificadorDocumentoOrigen != null)
        ? Constants.AUDIT_SEPARATOR_ROW + "IdentificadorDocumentoOrigen"
            + Constants.AUDIT_SEPARATOR_VALUE + this.identificadorDocumentoOrigen
        : "";
    return audit;
  }
}
