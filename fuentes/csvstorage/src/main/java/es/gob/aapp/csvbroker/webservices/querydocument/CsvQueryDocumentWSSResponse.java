...
@XmlType(name = "csvQueryDocumentWSSResponse", propOrder = {"queryDocumentResponse"})
public class CsvQueryDocumentWSSResponse {
   ...
   * 
   * @return possible object is {@link CSVQueryDocumentResponse }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CSVQueryDocumentResponse }
   * 
   */
